# 04_select_14bacteria.r — Select bacteria with coverage >= 100 reads in > 50% of individuals
...
#
# Usage: Rscript 04_select_14bacteria.r config.sh
...
pairs_out      <- file.path(RESULTS_DIR, "pairs_14bacteria_samples_ge100.tsv")
