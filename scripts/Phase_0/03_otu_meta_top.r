...
meta_file     <- META_FILE
otu_out       <- file.path(TABLES_DIR, "OTUtable_with_metadata.tsv")
top50_out     <- file.path(TABLES_DIR, "Top50_species_abundance_median.tsv")
otu_top50_out <- file.path(TABLES_DIR, "OTUtable_Top50_with_metadata.tsv")
