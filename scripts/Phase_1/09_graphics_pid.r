# 09_graphics_pid.r — Select best reference per species from BLAST results and plot % identity
# Input:  RESULTS_DIR/blast_top5_taxrep.tsv  (from 08_blast_match_top5.sh)
# Output: RESULTS_DIR/select_sp.tsv
#         RESULTS_DIR/plot_sp_ordered_bypid.png
#         RESULTS_DIR/plot_sp_by_family.png
#
# Usage: Rscript 09_graphics_pid.r config.sh
