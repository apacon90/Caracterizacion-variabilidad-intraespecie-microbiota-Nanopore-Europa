...
# 15_filter_pools.sh — Filter variants by quality (QUAL) and recurrence (>=3 pools per country)
# Input:  VCF_RAW_DIR/{species}_Spain|Norway|Portugal.vcf.gz  (from 14_indels_snps_VCF.sh)
