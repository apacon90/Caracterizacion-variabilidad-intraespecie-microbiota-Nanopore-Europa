#!/usr/bin/env bash
# 07_rrn_consensus_novo.sh — De novo assembly of ribosomal operon with Flye + Barrnap annotation
# Input:  SPECIES_READS_DIR/combined_1500/{species}.sampled.fa  (from 06_sample_sp_1500_reads.sh)
# Output: RRN_CONSENSUS_DIR/{species}/assembly.fasta
#         RRN_CONSENSUS_DIR/{species}/annotation.gff
#
# Usage: bash 07_rrn_consensus_novo.sh
