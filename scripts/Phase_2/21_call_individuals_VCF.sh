...
# 21_call_individuals_VCF.sh — Joint variant calling across all individuals per species
# Input:  IND_BAM_DIR/{species}/{country}/{sample}.bam  (from 20_map_individuals)
