#!/usr/bin/env bash
# 04_extract_reads_ge100_n100.sh — Extract reads per individual and species, subsample to N=100
...
#
# Usage: bash 04_extract_reads_ge100_n100.sh

set -euo pipefail
source "$(dirname "$0")/config.sh"

AUX_DIR="${PHASE2_DIR}/aux_extract_reads"
FASTA_ALL="${PHASE2_DIR}/fasta_all"
