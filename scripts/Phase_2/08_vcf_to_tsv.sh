#!/usr/bin/env bash
# 08_vcf_to_tsv.sh — Export filtered VCFs to TSV format
# Input:  IND_VCF_FILT_DIR/{species}.QUAL_100-150.vcf.gz  (from 07_filter_qual_individuals)
...
TSV_DIR="${PHASE2_DIR}/bacterias_tsv"
mkdir -p "$TSV_DIR"
