#!/usr/bin/env bash
# 06_call_individuals_VCF.sh — Joint variant calling across all individuals per species
# Input:  IND_BAM_DIR/{species}/{country}/{sample}.bam  (from 05_map_individuals)
...
# Usage: bash 06_call_individuals_VCF.sh
