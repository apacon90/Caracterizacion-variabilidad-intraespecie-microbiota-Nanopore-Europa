# 18_generate_pairs.R — Select bacteria with sufficient coverage and generate sample-bacteria pairs for Phase 2 individual analysis
...
#
# Usage: Rscript 18_generate_pairs.R config.sh
...
# --- Paths from config ---
otu_top50_file <- file.path(TABLES_DIR, "OTUtable_Top50_with_metadata.tsv")
